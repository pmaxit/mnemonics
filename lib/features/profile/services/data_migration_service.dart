...
class DataMigrationService {
  ...
  static VocabularyWord migrateVocabularyWord(Map<String, dynamic> json) {
    return VocabularyWord(
      ...
      difficulty: migrateDifficultyFromString(json['difficulty'] as String? ?? 'medium'),
  ...
  static Map<String, dynamic> convertToLegacyProfileStatistics(UserStatistics stats) {
    final categoryStats = stats.categoryStats.values.map((cat) => {
    ...
    final difficultyStats = stats.difficultyStats.values.map((diff) => {
