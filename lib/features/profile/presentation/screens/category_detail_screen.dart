...
class CategoryDetailScreen extends ConsumerWidget {
  ...
  Widget _buildMainStat(String label, String value, IconData icon, Color color, bool isDarkMode) {
    return Column(
      children: [
  ...
  Widget _buildProgressItem(String label, int count, int total, Color color, bool isDarkMode) {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildBreakdownItem(
            ...
            stats.totalWords > 0 ? (stats.strugglingWords / stats.totalWords) : 0.0,
            MnemonicsColors.warning,
            isDarkMode,
          ),
        ],
  ...
  Widget _buildBreakdownItem(String title, String value, double progress, Color color, bool isDarkMode) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
